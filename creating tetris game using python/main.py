...
background = pygame.image.load(r"C:\Users\HP\Downloads\Tetris Game\creating tetris game using python\front.jpg")
back = pygame.image.load(r"C:\Users\HP\Downloads\Tetris Game\creating tetris game using python\back2.jpg")
try_again = pygame.image.load(r"C:\Users\HP\Downloads\Tetris Game\creating tetris game using python\try.jpg")


#music = pygame.mixer.music.load(r'C:\Users\HP\Downloads\Tetris Game\creating tetris game using python\music.mp3')
    ...
    if inc > 0:
        for key in sorted(list(locked), key=lambda x: x[1])[::-1]:
            ...
            if y < ind:
                ...
                pygame.mixer.music.load(r'C:\Users\HP\Downloads\Tetris Game\creating tetris game using python\linecleared.wav')
...
def update_score(nscore):
    ...
    with open(r'C:\Users\HP\Downloads\Tetris Game\creating tetris game using python\scores.txt', 'w') as f:
        if int(score) > nscore:
            f.write(str(score))
        else:
            f.write(str(nscore))
...
def max_score():
    with open(r'C:\Users\HP\Downloads\Tetris Game\creating tetris game using python\scores.txt', 'r') as f:
        lines = f.readlines()
...
def main(win):  # *
    ...
    while run:
        ...
        if check_lost(locked_positions):
            pygame.mixer.music.load(r'C:\Users\HP\Downloads\Tetris Game\creating tetris game using python\gameover.wav')
            pygame.mixer.music.play()
